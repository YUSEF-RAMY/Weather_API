					...
					<div class="forecast-container">
						...
						<div class="today forecast">
							...
							<div class="forecast-content">
								<div class="location" style="font-size: 40px !important;">{{ $weather['location']['name'] ?? '--'}}</div>
								<div class="degree">
									<div class="num" style="font-size: 80px !important">{{ $weather['today']['day']['mintemp_c'] ?? '--' }} <sup>o</sup>C</div>
									<div class="forecast-icon row">
										<img  src="{{ $weather['today']['day']['condition']['icon'] ?? '--' }}" alt="" width=90>
									</div>	
								</div>
								<span><img src="images/icon-umberella.png" alt="">{{ $weather['current']['wind_degree'] ?? '--'}} %</span>
								<span><img src="images/icon-wind.png" alt="">{{ $weather['today']['day']['maxwind_kph']?? '--' }} km/h</span>
