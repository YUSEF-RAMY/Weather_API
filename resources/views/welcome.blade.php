...
<body>
    ...
    <div class="site-content">
            ...
            <div class="container">
                ...
                <div class="main-navigation">
                    ...
                    <ul class="menu">
                        ...
                        <li class="menu-item"><a href="{{ route('News-page') }}">News</a></li>
                        <li class="menu-item"><a href="{{ route('liveCam-page') }}">Live cameras</a></li>
                        <li class="menu-item"><a href="{{ route('Photos-page') }}">Photos</a></li>
                        <li class="menu-item"><a href="{{ route('ContactUs-page') }}">Contact</a></li>
                    </ul> <!-- .menu -->
                </div> <!-- .main-navigation -->
        ...
        <div class="hero" data-bg-image="images/banner.png">
            <div class="container">
				@if (session('city_not_found'))
					<div class="alert alert-danger" style="margin: auto;width:50%;color: rgb(228, 228, 228); text-align: center; border: 1px solid red; background-color: rgb(233, 91, 91)">
						{{ session('city_not_found') }}
					</div>
				@endif
                <form action="{{ route('weather.search') }}" method="GET" class="find-location">
                    <input type="text" name="city" placeholder="Find Your City...">
                ...
                <div class="forecast-container">
                    ...
                    <div class="today forecast">
                        <div class="forecast-header">
                            <div class="day">{{ $weather['today']['day_name'] ?? '--' }}</div>
                            <div class="date">{{ $weather['today']['date'] ?? '--' }}</div>
                        </div> <!-- .forecast-header -->
                        <div class="forecast-content">
                            <div class="location" style="font-size: 40px !important;">
                                {{ $weather['location']['name'] ?? '--' }}</div>
                            <div class="degree">
                                <div class="num" style="font-size: 80px !important">
                                    {{ $weather['today']['day']['mintemp_c'] ?? '--' }} <sup>o</sup>C</div>
                                <div class="forecast-icon row">
                                    <img src="{{ $weather['today']['day']['condition']['icon'] ?? '--' }}"
                                        alt="" width=90>
                                </div>
                            </div>
                            <span><img src="images/icon-umberella.png"
                                    alt="">{{ $weather['today']['hour'][0]['cloud'] ?? '--' }} %</span>
                            <span><img src="images/icon-wind.png"
                                    alt="">{{ $weather['today']['day']['maxwind_kph'] ?? '--' }} km/h</span>
                            {{-- <span><img src="images/icon-compass.png" alt="">East</span> --}}
                            <span>{{ $weather['today']['day']['condition']['text'] }}</span>
                        </div>
                    </div>

                    @foreach ($weather['next_days'] as $day)
                        <div class="forecast">
                            <div class="forecast-header">
                    ...
                    <div class="row">
                        <div class="col-md-3 col-sm-6">
                            <div class="live-camera">
                                <figure class="live-camera-cover"><img src="images/live-camera-1.jpg" alt="">
                                </figure>
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="live-camera">
                                <figure class="live-camera-cover"><img src="images/live-camera-2.jpg" alt="">
                                </figure>
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="live-camera">
                                <figure class="live-camera-cover"><img src="images/live-camera-3.jpg" alt="">
                                </figure>
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="live-camera">
                                <figure class="live-camera-cover"><img src="images/live-camera-4.jpg" alt="">
                                </figure>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="news">
                                ...
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Illo saepe assumenda
                                    dolorem modi, expedita voluptatum ducimus necessitatibus. Asperiores quod
                                    reprehenderit necessitatibus harum, mollitia, odit et consequatur maxime nisi amet
                                    doloremque.</p>
                            </div>
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            <div class="news">
                                <div class="date">06.10</div>
                                <h3><a href="#">Doloremque laudantium totam sequi </a></h3>
                                <p>Enim impedit officiis placeat qui recusandae doloremque possimus, iusto blanditiis,
                                    quam optio delectus maiores. Possimus rerum, velit cum natus eos. Cumque pariatur
                                    beatae asperiores, esse libero quas ad dolorem. Voluptates.</p>
                            </div>
                        </div>
                    </div>
                </div>
